...
from hyped.utils.feature_access import (
    join_feature_mappings,
    join_example_batches,
)
...
class ParallelDataPipeMixin(object):
    ...
    def prepare(self, features: datasets.Features) -> datasets.Features:
        ...
        return reduce(
            join_feature_mappings, (pipe.prepare(features) for pipe in self)
        )
    ...
    def new_features(self) -> datasets.Features:
        ...
        return reduce(
            join_feature_mappings, (pipe.new_features for pipe in self)
        )
    ...
    def out_features(self) -> datasets.Features:
        ...
        """
        return reduce(
            join_feature_mappings, (pipe.out_features for pipe in self)
        )
    ...
    def batch_process(
        ...
        merged_out_batch = reduce(join_example_batches, output_batches)
